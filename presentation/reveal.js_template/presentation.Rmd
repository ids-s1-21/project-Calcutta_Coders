...
=======
output:
>>>>>>> acb6716b2a769fa70a1f4deeb8c7876df2a97e02
  revealjs::revealjs_presentation:
    self_contained: false
`{data-background-image= "img/Kurosawa.jpg">}`
---
---
...
## To answer the research question posed on the first slide we will be using the country of origin, genre, us votes and non us votes and US and non US income for the films rated on IMDb. {data-background-image="img/confetti.jpg"}
