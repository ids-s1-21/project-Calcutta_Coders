...
This graph reveals the distribution of `avg_vote`, which is the rating, for every `genre`. As shown by the graph and the summary statistics, some high rated genres include Documentary, Film Noir, Biography, History, War and News. In these data tables, films with multiple genres were counted in each of their catagories.
```{r data-analysis-genre}
imdb_genre <- imdb %>%
...
This graph shows a positive association between the IMDb rating and the metascore. The graph also reveals that IMDb often rate their moves less than metascore rates them.
